...
<head>
  ...
  <title>Formulir Penilaian Keterbacaan Media</title>
...
<body>
  <div class="container">
    <span class="badge">
      ...
      Formulir Penilaian Keterbacaan Media
    </span>

    <header class="main-header">
      <h1>LEMBAR ANGKET PENILAIAN KETERBACAAN MEDIA E-LKPD INTERAKTIF TERINTEGRASI LABORATORIUM VIRTUAL 3D OLEH SISWA</h1>
      <p class="subtitle">
        Instrumen ini digunakan untuk menganalisis respon siswa terhadap keterbacaan media
    ...
    <section class="section" id="meta-section">
      ...
      <div class="section-body">
        ...
        <p>
          Instrumen ini digunakan untuk mengetahui tingkat keterbacaan media E-LKPD Interaktif Terintegrasi Laboratorium
          Virtual 3D yang kamu gunakan.
        </p>
        <p style="margin-top:8px;"><strong>Petunjuk pengisian</strong></p>
        <p>
          Mohon kamu memberikan penilaian dengan jujur sesuai pengalaman penggunaan E-LKPD Interaktif.
    ...
    <section class="section disabled" id="penilaian-section">
      <div class="section-title">
        ...
        <span class="step-label">Penilaian keterbacaan media</span>
      </div>
      <div class="section-body">
        <p>
        ...
        <div class="form-row" style="margin-top:12px;">
          <div class="form-group">
            <label for="saran-komentar">
              Saran dan Komentar (jika ada)
            </label>
            <textarea id="saran-komentar" placeholder="Tulis saran dan komentar kamu tentang E-LKPD Interaktif yang digunakan."></textarea>
          </div>
        </div>
        ...
        <div class="form-row" style="margin-top:12px;">
          <div class="form-group">
            <label>
              Kesimpulan penilaian keterbacaan media
              <span class="req">*</span>
            </label>
            ...
            <div>
              <label style="display:flex;align-items:flex-start;gap:6px;font-weight:400;margin-bottom:4px;font-size:13px;">
                ...
                <span>Seluruh aspek keterbacaan media telah terpenuhi secara lengkap sesuai kriteria yang ditetapkan.</span>
              </label>
              <label style="display:flex;align-items:flex-start;gap:6px;font-weight:400;margin-bottom:4px;font-size:13px;">
                <input type="radio" name="kesimpulan" value="2" style="margin-top:2px;" />
                <span>Sebagian besar aspek keterbacaan media telah terpenuhi, namun masih terdapat beberapa aspek yang perlu disempurnakan.</span>
              </label>
              <label style="display:flex;align-items:flex-start;gap:6px;font-weight:400;font-size:13px;">
                ...
                <span>Sebagian besar aspek keterbacaan media belum terpenuhi, sehingga diperlukan pengembangan lebih lanjut sebelum digunakan dalam pembelajaran.</span>
              </label>
            </div>
          </div>
        </div>
    ...
    <section class="section hidden" id="ttd-section">
      ...
      <div class="section-body signature-section">
        <div class="signature-card">
          ...
          <div class="signature-wrapper">
            <div class="signature-toolbar">
              <span><strong>Bidang tanda tangan</strong> • Sentuh dan geser untuk menulis</span>
        ...
        <div class="pdf-section">
          <div>
            <div>Setelah tanda tangan disimpan, kamu dapat mengunduh file PDF hasil penilaian keterbacaan media.</div>
            <div id="pdf-info" style="margin-top:4px;">
              PDF akan memuat identitas kamu, semua tabel penilaian, rekap skor, saran dan komentar, kesimpulan, dan kolom tanda tangan:
              <br />
              “Semarang, [tanggal] 2025, Validator, TTD, (Nama terang)”.
            </div>
          </div>
  ...
  <script>
    // Data aspek dan butir kriteria (sesuai dokumen)
    const aspekList = [
      {
        id: "keterpahaman",
        label: "Aspek Keterpahaman (Comprehensibility)",
        items: [
          "Tujuan pembelajaran dalam E-LKPD disampaikan dengan jelas dan mudah dipahami.",
          "Konsep-konsep IPA dijelaskan dengan bahasa sederhana dan sistematis.",
          "Penjelasan tidak menimbulkan makna ganda atau ambigu.",
          "Urutan penyajian materi logis dan mudah diikuti.",
          "Instruksi kegiatan mudah dipahami.",
          "Hubungan antara materi pada E-LKPD dan laboratorium virtual 3D jelas.",
          "Aktivitas computational thinking mudah dipahami.",
          "Pertanyaan atau soal mudah dimengerti."
        ]
      },
      {
        id: "kemudahan",
        label: "Aspek Kemudahan (Ease of Reading)",
        items: [
          "Ukuran huruf nyaman dibaca.",
          "Jenis huruf jelas dan mudah dibaca.",
          "Warna teks kontras dengan latar belakang.",
          "Kalimat tidak terlalu panjang dan mudah dipahami.",
          "Paragraf tidak terlalu padat.",
          "Tata letak teks rapi.",
          "Jarak antarbaris nyaman dibaca.",
          "Tidak lelah saat membaca teks.",
          "Navigasi antarhalaman mudah digunakan.",
          "Informasi penting mudah ditemukan."
        ]
      },
      {
        id: "kebahasaan",
        label: "Aspek Kebahasaan (Language and Style)",
        items: [
          "Bahasa sesuai tingkat pemahaman siswa SMP.",
          "Struktur kalimat baik dan benar.",
          "Tidak ada kesalahan ejaan atau tata bahasa.",
          "Bahasa komunikatif dan tidak kaku.",
          "Gaya bahasa menarik.",
          "Bahasa konsisten di seluruh bagian.",
          "Tidak ada singkatan membingungkan.",
          "Bahasa memotivasi untuk terus membaca."
        ]
      },
      {
        id: "visual",
        label: "Aspek Keterbacaan Visual (Visual Readability)",
        items: [
          "Gambar jelas dan berkualitas baik.",
          "Gambar mendukung pemahaman materi.",
          "Label/keterangan gambar mudah dibaca.",
          "Animasi tidak mengganggu konsentrasi.",
          "Video/simulasi terlihat jelas.",
          "Warna background tidak mengganggu teks.",
          "Kombinasi warna harmonis.",
          "Tampilan E-LKPD tidak terlalu ramai.",
          "Ikon dan simbol mudah dipahami."
        ]
      },
      {
        id: "organisasi",
        label: "Aspek Organisasi dan Struktur (Organization and Structure)",
        items: [
          "Setiap bagian memiliki judul yang jelas.",
          "Terdapat penanda antarbagian.",
          "Informasi disusun dari sederhana ke kompleks.",
          "Ada ringkasan atau poin penting.",
          "Setiap aktivitas memiliki petunjuk terorganisir.",
          "Tombol/fitur interaktif konsisten.",
          "Penanda visual membedakan jenis informasi.",
          "Alur pembelajaran runtut."
        ]
      },
      {
        id: "interaktivitas",
        label: "Aspek Interaktivitas dan Responsivitas",
        items: [
          "Tombol navigasi mudah diklik dan responsif.",
          "E-LKPD Interaktif mudah dioperasikan.",
          "Laboratorium virtual 3D mudah dioperasikan.",
          "Instruksi interaksi dengan laboratorium jelas.",
          "Tidak ada hambatan teknis."
        ]
      },
      {
        id: "kesesuaian",
        label: "Aspek Kesesuaian dengan Pengguna",
        items: [
          "Dapat digunakan untuk belajar mandiri.",
          "Sesuai dengan gaya belajar saya.",
          "E-LKPD membantu saya berpikir logis dan sistematis."
        ]
      }
    ];
    ...
    btnSimpanPenilaian.addEventListener("click", () => {
      ...
      const kesimpulanMap = {
        "1": "Seluruh aspek keterbacaan media telah terpenuhi secara lengkap sesuai kriteria yang ditetapkan.",
        "2": "Sebagian besar aspek keterbacaan media telah terpenuhi, namun masih terdapat beberapa aspek yang perlu disempurnakan.",
        "3": "Sebagian besar aspek keterbacaan media belum terpenuhi, sehingga diperlukan pengembangan lebih lanjut sebelum digunakan dalam pembelajaran."
      };
      ...
      // Tampilkan rekap skor ringkas
      let lines = [];
      for (const key of Object.keys(rekapSkor)) {
        const r = rekapSkor[key];
        lines.push(
          `${r.label}: ${r.skor} dari ${r.skorMaks} (butir: ${r.jumlahButir})`
        );
      }
    ...
    btnDownloadPDF.addEventListener("click", () => {
      ...
      doc.setFontSize(12);
      doc.text(
        "LEMBAR ANGKET PENILAIAN KETERBACAAN MEDIA E-LKPD INTERAKTIF TERINTEGRASI LABORATORIUM VIRTUAL 3D OLEH SISWA",
        105,
        y,
        { align: "center" }
      );
      ...
      const judulLines = doc.splitTextToSize(judul, 180);
      doc.text("Judul penelitian :", margin, y);
      doc.text(judulLines, margin + 36, y);
      y += judulLines.length * 4 + 4;
      ...
      const tujuan =
        "Instrumen ini digunakan untuk menganalisis respon pengguna terhadap keterbacaan media E-LKPD Interaktif Terintegrasi Laboratorium Virtual 3D pada materi suhu, kalor, dan pemuaian.";
      const tujuanLines = doc.splitTextToSize(tujuan, 180);
      doc.text(tujuanLines, margin, y);
      y += tujuanLines.length * 4 + 4;
      ...
      const petunjuk =
        "Mohon siswa memberikan penilaian atas media E-LKPD Interaktif Terintegrasi Laboratorium Virtual 3D yang telah digunakan. Berikan skor dengan memberikan tanda centang pada kolom STS, TS, S, atau SS untuk setiap pernyataan.";
      const petunjukLines = doc.splitTextToSize(petunjuk, 180);
      doc.text(petunjukLines, margin, y);
      y += petunjukLines.length * 4 + 4;

      doc.setFontSize(9);
      doc.text("Keterangan: STS = 1, TS = 2, S = 3, SS = 4.", margin, y);
      y += 5;

      // Tabel penilaian dengan tanda centang
      const tableHead = [["Aspek yang Dinilai", "Kriteria", "STS", "TS", "S", "SS"]];
      const tableBody = [];
      ...
      doc.setFontSize(10);
      doc.setFont("helvetica", "bold");
      doc.text("Saran dan Komentar", margin, y);
      y += 5;
      doc.setFont("helvetica", "normal");
      ...
      y += kesimpulanLines.length * 4 + 4;

      // Blok tanda tangan di kanan bawah
      const pageHeight = doc.internal.pageSize.getHeight();
      const pageWidth = doc.internal.pageSize.getWidth();
      let sigY = Math.max(y + 10, pageHeight - 70);

      const tglTTD = formatTanggalIndo(formIdentitas.tanggal);
      const teksTanggal = `Semarang, ${tglTTD}`;
      doc.text(teksTanggal, pageWidth - margin, sigY, { align: "right" });
      sigY += 6;

      doc.text("Validator", pageWidth - margin, sigY, { align: "right" });
      sigY += 4;
      ...
      const sigYImg = sigY + 2;
      doc.addImage(signatureDataUrl, "PNG", sigX, sigYImg, sigWidth, sigHeight);

      sigY = sigYImg + sigHeight + 6;
      doc.text(`(${formIdentitas.nama})`, pageWidth - margin, sigY, { align: "right" });

      doc.save(`Penilaian_Keterbacaan_${formIdentitas.nama || "siswa"}.pdf`);
    });
    ...
    document.addEventListener("DOMContentLoaded", () => {
      ...
      window.addEventListener("resize", () => {
        // Jangan resize jika sudah ada tanda tangan
        if (!isSignatureDrawn) {
          initCanvas();
        }
      });
